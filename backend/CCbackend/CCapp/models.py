...
class MenuAnalytics(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'MenuAnalytics'


class MenuModifier(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    menu = models.ForeignKey(Menu, models.DO_NOTHING, blank=True, null=True)
    modifier = models.ForeignKey('Modifier', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'MenuModifier'


class Modifier(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    category = models.ForeignKey('ModifierCategory', models.DO_NOTHING, blank=True, null=True)
    name = models.CharField(max_length=255)
    additional_price = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class OrderItemModifier(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    order_item = models.ForeignKey(OrderItem, models.DO_NOTHING, blank=True, null=True)
    modifier = models.ForeignKey(Modifier, models.DO_NOTHING, blank=True, null=True)
